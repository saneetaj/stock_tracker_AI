...
def combine_signals(data: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        data["Buy_Signal_Combined"] = data["Buy_Score"] >= 0.1  # Buy if the combined score is high
        data["Sell_Signal_Combined"] = data["Sell_Score"] >= 0.5 # Sell if combined score is high
